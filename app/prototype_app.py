...
# Standardize both images using identical normalization
...
# Step 2: Mathematical Representation & Comparison Table
st.markdown("### 📐 Recovered Mathematical Representation")
if active_mode == "CONTROLLED_DEMO":
